            ...
            <div class="col-6">
                <form method="" action="" class="needs-validation" novalidate>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input id="name" name="name" type="text" class="form-control @if ($errors->first('name')) is-invalid @endif" value="">
                        <div class="invalid-feedback">Nieprawidłowa nazwa!</div>
                    </div>
                    <div class="form-group mb-2">
                        <label for="code" class="form-label">Kod</label>
                        <input id="code" name="code" type="text" class="form-control @if ($errors->first('code')) is-invalid @endif" value="">
                        <div class="invalid-feedback">Nieprawidłowy kod!</div>
                    </div>
                    <div class="form-group mb-2">
                        <label for="currency" class="form-label">Waluta</label>
                        <input id="currency" name="currency" type="text" class="form-control @if ($errors->first('currency')) is-invalid @endif" value="">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <div class="input-group mb-2">
                            <input id="area" type="number" name="area" min="0" placeholder="0"
                                step="any" class="form-control @if ($errors->first('area')) is-invalid @endif" value="">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input id="language" name="language" type="text" class="form-control @if ($errors->first('language')) is-invalid @endif" value="">
