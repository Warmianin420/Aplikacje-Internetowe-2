          ...
          <div class="card">
            <?php foreach ($trips as $trip): ?>
              <div class="col-md-4">
                <div class="card mb-4">
                  <div class="card-body">
                  <h5 class="card-title"><?php echo $trip->location; ?></h5>
                            <p class="card-text"><strong>Lokalizacja:</strong> <?php echo $trip->location; ?></p>
                            <p class="card-text"><strong>Data:</strong> <?php echo $trip->period; ?></p>   
                  </div>
                </div>   
              </div>   
            <?php endforeach ?>
